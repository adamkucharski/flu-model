...
thetaSim=c(mu=4,tau1=0,sigma=0.3,tau2=0.1,wane=0.1)
npartM=100
...
run_mcmc(test.yr=2010,runs=4000,hist.true=NULL,varpart_prob=vp1,test_years,inf_years,strain_years,n_part,test.list,theta0,switch1=2)
#historytabSim
