...
theta.serology=c(error=0.1,sigma=0.4) 
 
simulate_sera_data(strains=5,inf.years.sera=c(1976:2015),time.series.in=NULL,theta=theta.serology,p.inf.in=0.04*c(1,1,1,1,1),sd.val.in=1.5,seedi=1,roundv=F,dmatrix.in=NULL,zikv.attack=0.3)
